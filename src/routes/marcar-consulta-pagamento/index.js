...
class MarcarConsultaPagamento extends Component{
    ...
    render(){return (
        ...
        <section class="tab-header">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <Link to="/auth/consultas/marcadas" className="btn btn-clean btn-icon js-back">
                ...
                <div class="row flex-order">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="d-inline mb-30">
                            <h2 class="mb-10">Realize o pagamento para confirmar sua teleconsulta.</h2>
                            <h3>A sala virtual ainda não está preparada. Realize o pagamento para que possa realizar uma teleconsulta com o médico.</h3>
                        </div>
                        <div class="d-inline mb-20">
                            <a href="#!" data-toggle="modal" data-target="#modal-informacoes" class="group-avatar">
                        ...
                        <div class="d-inline mb-30">
                            <h2 class="small">Ortopedia</h2>
                            <h3>Consulta: CM45KO6R7</h3>
                        </div>
                    </div>
    
                    <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4 col-lg-offset-1 col-mob-full">
                        <form onSubmit={this.handleSubmit} data-toggle="validator">
                            <CardPagamento/>
                        </form>
                        <div class="text-center mt-30">
                            <Link to="/auth/consultas/marcadas" className="btn btn-clean">Recusar teleconsulta</Link>
                        </div>
                    </div>
...
export default MarcarConsultaPagamento;
